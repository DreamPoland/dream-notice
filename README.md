...
- Paper (native-support 1.16.5+) - [paper-adventure](https://github.com/DreamPoland/dream-notice/tree/master/paper-adventure)
...
```groovy
implementation "cc.dreamcode.notice:{platform}:1.4-beta.10"
```
