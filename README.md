...
```groovy
implementation "cc.dreamcode.notice:{platform}:1.6.10"
```
...
Or use module with -adventure suffix, `cc.dreamcode.notice:platform-adventure:1.6.10` for better support. (use only core and adventure module)
